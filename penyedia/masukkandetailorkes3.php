				...
				<div class="panel">
	       			<div style="padding: 40px 40px 40px 40px">
	       				...
	       				<div class="row">
				            <div class="col-lg-6">
				                <div class="panel">
				                	<form method="POST" action="../penyedia/index.php?page=masukkandetail3&imei=<?php echo "$imei" ?>" enctype="multipart/form-data">
												...
												<span class="input-group-btn">
												    <div class="btn btn-default image-preview-input">
												        ...
												        <span class="image-preview-input-title">Browse</span>
												       	<input type="file" name="fotopenyanyi" onchange="document.getElementById('panggung').src = window.URL.createObjectURL(this.files[0])">
												    </div>
												</span>
												<input type="text" name="nama_penyanyi" class="form-control" placeholder="Masukkan Nama Penyanyi">
											</div>
								        </div>
										<div class="form-group">
											<button class="btn btn-warning" name="penyanyi">Tambah Penyanyi</button>
											<a href="?page=masukkandetail4&imei=<?php echo "$imei" ?>" class="btn btn-success" style="width: 58%">Selanjutnya</a>
										</div>
									</form>
				            	</div>
				        	</div>
				        	<div class="col-lg-12">
				                <table border="1" align="right" style="width: 100%">
									<tr align="center">
										...
										<td style="padding: 10px; width: 25%"><b>Nama Penyanyi</b></td>
										<td style="padding: 10px 25px 10px 25px; width: 30%"><b>Aksi</b></td>
									</tr>
									<?php
				        			$tampil=mysqli_query($db, "SELECT * from penyanyi where id_tipe = '$imei'");
									while ($r=mysqli_fetch_array($tampil))
										{
 											echo"
											<tr align='center'>
												<td style='padding: 10px'><img src='gambar/penyanyi/$r[foto]' width='100%''></td>
												<td style='padding: 10px'>$r[nama_penyanyi]</td>
												<td><a href='?page=masukkandetail2' class='btn btn-success'>Edit </a> <a href='delete.php?stat=penyanyi&imei=$r[id_tipe]&id=$r[id_penyanyi]' class='btn btn-danger'> Hapus</a></td>
											</tr>";
										}
								echo "</table>";
								?>
