			      			...
			      			<div style="padding: 30px">
								...
								?>
					       		<div class="col-md-4 col-sm-6 col-lg-2">
								    <div class="thumbnail">
								      <img src="<?php echo "../penyedia/gambar/dekorasi/".$d['foto']; ?>">
								      <div class="caption">
								...
								?>
					       		<div class="col-md-4 col-sm-6 col-lg-2">
								    <div class="thumbnail">
								      <img src="<?php echo "../penyedia/gambar/penyanyi/".$p['foto']; ?>">
								      <div class="caption">
								...
								?>
					       		<div class="col-md-4 col-sm-6 col-lg-2">
								    <div class="thumbnail">
								      <img src="<?php echo "../penyedia/gambar/pemusik/".$pe['foto']; ?>">
								      <div class="caption">
								...
								<div class="col-md-12">
									<span class="pull-right">
										<a href="index.php?page=lihatorkes&penyedia=<?php echo "$getpenyedia"; ?>" class="btn btn-info">Kembali</a>
									</span>
								</div>
				   	 		</div>
				   	 	</div>
